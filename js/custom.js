...
/*$(window).ready(function() {
	...
	$.vegas('slideshow', {
	  backgrounds:[
		{ src:'http://www.unitedway.org/i/uww-photo/income/uw-bitcoin.jpg', fade:1000 }
	  ]
	})();
});*/
...
$(document).ready(function() {
	...
	$('#subscription-form').ajaxChimp({
		...
		url: 'http://nxthaus.us10.list-manage.com/subscribe/post?u=28d138a2caa15cb9a2764280a&amp;id=f43fd6c64e' /* Replace it with your custom URL inside '' */
	});
